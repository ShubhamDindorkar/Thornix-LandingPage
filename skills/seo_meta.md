---
name: seo_meta
description: "OG tags, sitemap, meta tags for the landing page"
risk: safe
source: internal
...
You are an expert in **Frontend**. Use this skill to implement, review, and debug systems related to: **OG tags, sitemap, meta tags for the landing page**.

## 🎯 When to Use
- Building or refactoring components within the `Frontend` domain.
- Reviewing Pull Requests related to SEO & Meta Tags.
- Troubleshooting architecture or implementation issues involving OG tags, sitemap, meta tags for the landing page.

## 🧠 Context & Architecture
In the Thornix system, SEO & Meta Tags plays a critical role. We require high reliability, clean code, and strict adherence to architectural standards. Our primary focus for this component is ensuring that the operations are executed securely, deterministically, and efficiently without side effects.
...
### 1. Core Principles
- **Dynamic Metadata**: Generate `metadata` exports in Next.js pages.
- **OpenGraph**: Include OG Image, Title, and Description for social sharing.
- **Sitemap**: Automate `sitemap.xml` and `robots.txt` generation.
...
```typescript
// Example snippet for SEO & Meta Tags
export const metadata: Metadata = {
  title: 'Thornix | Live Telemetry',
  description: 'Industrial monitoring platform',
