...
description: "encrypted backup of signal and alert logs"
risk: safe
source: internal
...
You are an expert in **Data & Storage**. Use this skill to implement, review, and debug systems related to: **encrypted backup of signal and alert logs**.

## 🎯 When to Use
- Building or refactoring components within the `Data & Storage` domain.
- Reviewing Pull Requests related to S3 Object Storage Backup.
- Troubleshooting architecture or implementation issues involving encrypted backup of signal and alert logs.

## 🧠 Context & Architecture
In the Thornix system, S3 Object Storage Backup plays a critical role. We require high reliability, clean code, and strict adherence to architectural standards. Our primary focus for this component is ensuring that the operations are executed securely, deterministically, and efficiently without side effects.
...
### 1. Core Principles
- **Cold Storage**: Offload data older than 6 months from Timescale to S3 (Parquet format).
- **Encryption**: Enable AES-256 server-side encryption.
- **Lifecycle**: Set S3 lifecycle rules to transition to Glacier after 1 year.
...
```typescript
// Example snippet for S3 Object Storage Backup
